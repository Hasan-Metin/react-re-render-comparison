...
export default SelfDriven;`,
  },
  {
    ...
    code: `import { useCallback, useState, useImperativeHandle, memo, type Ref } from "react";
import useRenderCount from "../hooks/useRenderCount";
...
const BoxSelfDriven: React.FC<BoxSelfDrivenProps> = ({ increase, ref }) => {
  ...
  // Expose increment method to parent via ref (escape hatch pattern)
...
export default memo(BoxSelfDriven);  // memo works well here - no props change`,
  },
];
